...
def test_abort_multipart_upload_abort_multipart_upload_post(client: TestClient):
    """Test case for abort_multipart_upload_abort_multipart_upload_post
...
def test_complete_upload_complete_upload_post(client: TestClient):
    """Test case for complete_upload_complete_upload_post
...
def test_get_presigned_urls_presigned_urls_post(client: TestClient):
    """Test case for get_presigned_urls_presigned_urls_post
