...
if __name__ == "__main__":
    ...
    move_datablock_to_lts_flow_deploy = move_datablock_to_lts_flow.to_deployment(name="DEV_move_datablock_to_lts_flow")
    ...
    serve(archiving_deploy, retrieval_delpoy, create_test_dataset, move_datablock_to_lts_flow_deploy)
